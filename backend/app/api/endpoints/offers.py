...
def create_offer_endpoint(payload:OfferCreate,db:Session=Depends(get_async_session)):
...
async def get_all_endpoint(db:Session=Depends(get_async_session),params:OfferSearch=Depends()):
